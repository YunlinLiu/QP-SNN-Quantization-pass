...
parser.add_argument('-c', '--config', default='cifar100-prun.yml', type=str, metavar='FILE',
...
def main():
    ...
    state_dict = torch.load('/data/users/weiwj/Spikingformer-master/cifar100-prun/prun_weight.pt')
    del state_dict['block.3.mlp.mlp2_conv.weight']
    del state_dict['block.3.mlp.mlp2_bn.weight']
    del state_dict['block.3.mlp.mlp2_bn.bias']
    del state_dict['block.3.mlp.mlp2_bn.running_mean']
    del state_dict['block.3.mlp.mlp2_bn.running_var']
