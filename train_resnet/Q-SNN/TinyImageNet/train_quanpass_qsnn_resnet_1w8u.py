#!/usr/bin/env python3
# Train Q-SNN ResNet-20 on TinyImageNet using pass-based quantization (1w-8u)
...
parser = argparse.ArgumentParser("TinyImageNet ResNet-20 Q-SNN (1w-8u) Quant + Train")

parser.add_argument('--arch', type=str, default='resnet_20', help='architecture')
parser.add_argument('--job_dir', type=str, default='/workspace/QP-SNN-Quantization-pass/output_resnet_quan/Q-SNN/TinyImageNet/QSNN_1w8u/', help='path for saving models')
...
logger = common.get_logger(os.path.join(args.job_dir, 'ResNet_TinyImageNet_QSNN_1w8u_'+now+'.log'))
