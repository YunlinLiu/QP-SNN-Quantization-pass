...
class vggsnn(nn.Module):
    def __init__(self, compress_rate, num_classes, cfg=None, step=10):
...
def vggsnn_model(compress_rate, num_classes, cfg=None, step=10):
    return vggsnn(compress_rate=compress_rate, num_classes=num_classes, cfg=cfg, step=step)
