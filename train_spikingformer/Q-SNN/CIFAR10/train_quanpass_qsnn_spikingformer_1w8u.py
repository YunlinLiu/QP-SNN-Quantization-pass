...
# 与 ReScaW 脚本一致的导入风格，但按当前脚本层级修正到仓库根
...
parser.add_argument('-vb', '--val-batch-size', type=int, default=256, metavar='N',
                    help='input val batch size for training (default: 256)')
...
parser.add_argument('--output', default='./output_spikingformer_quan/Q-SNN/CIFAR10/QSNN_1w8u', type=str, metavar='PATH',
...
def main():
    ...
    # Apply Q-SNN quantization pass to the freshly created (float) model before training
    pass_args = {
        "by": "regex_name",
    ...
    if args.rank == 0:
        ...
        output_dir = get_outdir(args.output if args.output else './output_spikingformer_quan/Q-SNN/CIFAR10/QSNN_1w8u', exp_name)
