...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='./output_spikingformer_quan/Q-SNN/DVS-CIFAR10/QSNN_q2', help='path where to save')
...
def main(args):
    ...
    # ---- DVS variant (cifar10-dvs) Q-SNN pass args (bits=2 for voltage; apot 8-bit on patch/head) ----
    pass_args_dvs = {
        "by": "regex_name",
        ...
        r"patch_embed\.proj[1-4]_lif$": {"config": {"name": "lifspike_q_cupy", "num_bits": 2, "tau": 1.5}},
        r"block\.\d+\.attn\.attn_lif$": {"config": {"name": "lifspike_q_cupy", "num_bits": 2, "tau": 1.5, "thresh": 0.5}},
        r"block\.\d+\.attn\.(proj_lif|q_lif|k_lif|v_lif)$": {"config": {"name": "lifspike_q_cupy", "num_bits": 2, "tau": 1.5}},
        r"block\.\d+\.mlp\.(mlp1_lif|mlp2_lif)$": {"config": {"name": "lifspike_q_cupy", "num_bits": 2, "tau": 1.5}},
    }
