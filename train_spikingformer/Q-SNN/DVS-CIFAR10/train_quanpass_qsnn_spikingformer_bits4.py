...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='./output_spikingformer_quan/Q-SNN/DVS-CIFAR10/QSNN_q4', help='path where to save')
...
def main(args):
    ...
    # ---- DVS variant (cifar10-dvs) Q-SNN pass args (bits=4 for voltage; apot 8-bit on patch/head) ----
    pass_args_dvs = {
        "by": "regex_name",
