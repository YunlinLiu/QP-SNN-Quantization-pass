...
""" ImageNet Training Script (Vanilla 8-bit quantization)
...
project_root = Path(__file__).resolve().parents[2]  # Go up to /workspace/QP-SNN-Quantization-pass
...
parser.add_argument('--output', default='./output_spikingformer_quan/CIFAR10/', type=str, metavar='PATH',
                    help='path to output folder (default: none, current dir)')
parser.add_argument('--experiment', default='Vanilla_q8', type=str, metavar='NAME',
...
def main():
    ...
    if args.rank == 0:
        ...
        output_dir = get_outdir(args.output if args.output else './output_spikingformer_quan/CIFAR10/', exp_name)
