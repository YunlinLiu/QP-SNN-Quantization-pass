...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='/workspace/QP-SNN-Quantization-pass/output_spikingformer_quan/QP-SNN/DVS-Gesture/ReScaW_q4', help='path where to save')
