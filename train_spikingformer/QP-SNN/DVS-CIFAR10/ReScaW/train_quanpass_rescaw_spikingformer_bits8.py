...
import sys
project_root = Path(__file__).resolve().parents[4]  # 修正路径深度：4层
...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='./output_spikingformer_quan/QP-SNN/DVS-CIFAR10/ReScaW_q8', help='path where to save')
...
def main(args):
    ...
    # 插入量化：ReScaW 8-bit，仅 Transformer Blocks 卷积
