...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='./output_spikingformer_quan/QP-SNN/DVS-CIFAR10/ReScaW_q4', help='path where to save')
...
def main(args):
    ...
    # 插入量化：ReScaW 4-bit，仅 Transformer Blocks 卷积
